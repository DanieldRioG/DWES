...
require_once __DIR__ . '/fuente/Controlador/ProductosController.inc'; /*controladores */
require_once __DIR__ . '/fuente/Controlador/RecursosHumanosController.inc'; /*controladores */
